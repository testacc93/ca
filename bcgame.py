...
driver.get("https://www.bc.game/signin") 
no_users = ' ' 
...
#sign_in.click() 
# signin_button = driver.find_element_by_xpath("/html/body/div[4]/div/div/div[2]/p")
# signin_button.click()
 
# login = driver.find_element_by_xpath('/html/body/div[9]/div/div[2]/div[2]/div[1]/div[1]/div[1]/div[2]/input') 
# login.send_keys('parvaiziqra@gmail.com') 
 
# password = driver.find_element_by_xpath('/html/body/div[9]/div[1]/div[3]/form/input[2]') 
# password.send_keys('Bhagirath@93') 

# time.sleep(20)
# chat_icon = driver.find_element_by_xpath("/html/body/div[4]/div/div/div[2]/button[3]/div") 
# chat_icon.click()
...
for j in range(0,1): 
    if j >= 0: 
        for i in range(0, len(data)-1): 
            ...
            # print(no_users) 
            tweet = driver.find_element_by_xpath('/html/body/div[10]/div/div[2]/div[3]/div[1]/div[1]/div/textarea') 
